...
var baselineDocBlocks = map[string]int{
	...
	"codec_budget_test.go":                20,
	"codec_campaign_bench_test.go":        2,
	"codec_campaign_internal_test.go":     4,
	"codec_campaign_strings_test.go":      1,
	"codec_coder_test.go":                 6,
	"codec_containers_test.go":            2,
	"codec_errorgold_badpath_test.go":     2,
	...
	"codec_ppr_props_test.go":             7,
	"codec_ppr_parity_test.go":            1,
	"codec_prop_test.go":                  11,
	"codec_root_test.go":                  1,
	"codec_rt_test.go":                    3,
	"codec_scaling_probe_test.go":         1,
	"codec_stable_guard_test.go":          2,
	"codec_stable_pair_test.go":           3,
